<?php
    ...
    function alterarContato() {  
        ...
        try {
            // Alteração da tabela de telefones_cli (Contato)
            $connect->query("UPDATE telefones_cli SET TIPO = '".$_POST['tipoContatoAlterar']."', TEL = '".$_POST['numeroContatoAlterar']."' WHERE cliente_ID = ".$_SESSION["id"].";");
