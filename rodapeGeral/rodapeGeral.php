    ...
    <form id="form_oferta" action="../enviar_form.php">
        <div class="flex">
            ...
            <div class="d-flex align-items-center justify-content-center w15">
                <button role="button" value="Enviar" id="botao_oferta" aria-label="enviar" class="btn btn-primary p-2 botao_form" style="font-weight: bold; font-size: 20px;">Enviar</button>
            </div>
        </div>
    </form>
</div>
